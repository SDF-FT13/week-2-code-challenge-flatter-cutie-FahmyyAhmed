...
document.addEventListener("DOMContentLoaded", () => {
    ...
    fetch("https://flatacuties-vercel-git-main-fahmyahmeds-projects.vercel.app/characters")
    ...
    votesForm.addEventListener("submit", (event) => {
        ...
        fetch(`https://flatacuties-vercel-git-main-fahmyahmeds-projects.vercel.app/characters/${currentCharacter.id}`, {
            method: "PATCH",
